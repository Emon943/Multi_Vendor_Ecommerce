    <div class="page-bottom-info">
        <div class="page-bottom-info-inner">
            ...
            <div class="page-bottom-info-content text-center">
                <h1>CREATE YOUR ACCOUNT ON AWWAZZ, IT'S FREE!</h1>
                <a class="btn  btn-lg btn-primary-dark" href="sign">
    ...
    <div class="footer" id="footer">
        <div class="container">
            <ul class=" pull-left navbar-link footer-nav">
                <li><a href="about"> About </a> <a href="terms"> Terms and
                    Conditions </a> <a href="privacy"> Privacy Policy </a>  <a
                        href="help"> Help </a>
            </ul>
...
s1.async=true;
s1.src='https://embed.tawk.to/585b7ce9b7a6946c1d5ef180/default';
s1.charset='UTF-8';
