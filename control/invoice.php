                        ...
                        <div class="col-sm-6">
                            <div class="seller-info seller-profile">
								...
								<dl class="dl-horizontal">
											...
											<dd class="contact-sensitive"> <?php 
								$s_cat=$row_u["user"]; 
								$cat_r=mysqli_query($con,"select name from user where id=$s_cat");
								...
								<?php if($row_u['status']=="0"){ ?> 											
											<a class="btn btn-sm   btn-success " href="status?id=<?php echo $row_u['id']; ?>&c=1"><i class="fa fa-truck"></i> Deliver Now </a>
											<?php } else if($row_u['status']=="1") { ?>
											<a class="btn btn-sm   btn-success " href="status?id=<?php echo $row_u['id']; ?>&c=2"><i class="fa fa-check-square-o"></i> Make Recieved </a>
											<a class="btn btn-sm   btn-danger " href="status?id=<?php echo $row_u['id']; ?>&c=3"><i class="fa fa-times-circle-o"></i> Make Rejected </a>
											
											<?php } else  { ?>
											<a class="btn btn-sm   btn-danger " href=""><i class="fa fa-trash"></i> Delete this Order </a>
											<?php } ?>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-thin-left page-content ">
                            ...
                            <div class="category-list">
								...
								<h5>Product Code: <?php echo $r_p['id']; ?></h5>
                                            </div>
                                        </div>
                                        <!--/.add-desc-box-->
                                        <div class="col-sm-3 text-right  price-box">
                                            ...
                                            <a class="btn btn-danger  btn-sm make-favorite" href="p_view?id=<?php echo $r_p['id']; ?>"> <i
                                                    class="fa fa-eye"></i> <span>See Product</span> </a> 
