...
if(isset($_POST['inst'])){
	...
	mysqli_query($con,"insert into product(`title`,`s_cat`,`loc`,`short_des`,`brand`,`price`,`user`,`img1`,`img2`,`img3`,`status`) values('$title',$cat,$loc,'$des','$brand',$price,$user,'$f_insnt1','$f_insnt2','$f_insnt3',0)");
...
$pro=mysqli_query($con,"select * from product where status=0");
?>
