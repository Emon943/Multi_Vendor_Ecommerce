...
function FPDF($orientation='P', $unit='mm', $format='A4')
{
	...
	//Page format
	$this->PageFormats=array('a3'=>array(841.89,1190.55), 'a4'=>array(595.28,841.89), 'a5'=>array(420.94,595.28),'a6'=>array(410.94,365.28),
...
function Rect($x, $y, $w, $h, $style='')
{
	...
	// Added new boolean parameter $pathAndFile to allow inclusion of new fonts from within the TYPO3 framework.
	// If $pathAndFile is set, the function will try to include the file specified in this parameter instead of
	// trying to include $file in the include-path.
	//
	// Original line:
	// function AddFont($family,$style='',$file='')
function AddFont($family,$style='',$file='',$pathAndFile='')
{
...
function _putfonts()
{
	...
	foreach($this->FontFiles as $file=>$info)
	{
		...
		if ($GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['fpdf']['fonts'][$file])		{
			$f=fopen($GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['fpdf']['fonts'][$file][2].$file,'rb',1);
		} else {
