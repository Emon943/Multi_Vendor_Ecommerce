...
if(isset($_POST['inst'])){
	...
	mysqli_query($con,"insert into product(`title`,`s_cat`,`loc`,`short_des`,`brand`,`price`,`user`,`img1`,`img2`,`img3`) values('$title',$cat,$loc,'$des','$brand',$price,$u_id,'$f_insnt1','$f_insnt2','$f_insnt3')");
...
$pro=mysqli_query($con,"select * from product where user=$u_id and status=1");
?>
                                    ...
                                    <td style="width:58%" class="ads-details-td">
                                        <div>
                                            ...
                                            <p><strong> Posted On </strong>:
                                                <?php echo $row_p["date"]; ?> <strong>Visitors </strong>: <?php echo $row_p["view"]; ?></p>
