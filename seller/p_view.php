    ...
    <div class="main-container">
        <div class="container">
            <ol class="breadcrumb pull-left">
                ...
                <li><a href="all_product">All Ads</a></li>
                        ...
                        <div class="Ads-Details">
                            ...
                            <div class="row">
								...
								if(mysqli_num_rows($fav_r)>0){ } else {?>  
											...
											<li><a href="fav?id=<?php echo $row_p["id"]; ?>"> <i class=" fa fa-heart"></i> Add to Favourite </a></li>
								<?php } ?>		
                            ...
                            <div class="panel-content user-info">
                                <div class="panel-body text-center">
                                    <div class="seller-info">
                                        ...
                                        <p> Product ID: <strong><?php echo $p_id; ?></strong></p>
                                    </div>
