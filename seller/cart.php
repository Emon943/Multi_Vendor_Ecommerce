...
if(isset($_POST['inst'])){
	...
	$subject="Customer Invoice!";
		...
		$code="Dear customer,\nYour checkout has been successful! This is considered an email invoice.\n\nInvoice Id: $lst_id\nTotal Product: $product\nTotal amount: $price\nPayment Method: $pmnt\nDelivery Address: $address\n\nYou can also export this voucher from login to your account. Thank you very much for being with Awwazz.com\n\nFor more details please contact us at: +8801979955603-4 ";	
